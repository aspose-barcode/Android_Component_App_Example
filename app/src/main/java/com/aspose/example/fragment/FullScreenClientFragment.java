...
import com.aspose.barcode.component.barcodescanner.BarcodeRecognitionResultsHandler;
 ...
 * Use the {@link FullScreenClientFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FullScreenClientFragment extends Fragment {
    ...
    public FullScreenClientFragment() {
     ...
     * @return A new instance of fragment FullScreenClientFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FullScreenClientFragment newInstance(String param1, String param2) {
        FullScreenClientFragment fragment = new FullScreenClientFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        barcodeScannerFragment.getBarcodeRecognitionSettings().setBarcodeRecognitionResultHandler(new BarcodeRecognitionResultsHandler() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_full_screen_client, container, false);
    }
}